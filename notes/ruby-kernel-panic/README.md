...
Ruby cheat sheets for my future self
...
* [Object orientation](oop.md)
* [Objects and hierarchies](objects-hierarchies.md)
* [Getters and setters](getters-setters.md)
* [Equality and comparison](equality-comparison.md)
* [Scope: local variables](local-variable-scope.md)
* [Scope: instance and class variables](class-instance-variable-scope.md)
* [Blocks, procs, and lambdas](blocks-procs-lambdas.md)
